...
path = r"D:\DATA\REM\REM_2025\Datos\SerieP2025.csv"
...
df_gestantes.to_excel('output/REM_2025_P1_SECCION_D_GESTANTES.xlsx')
#%%
...
df_nodrizas.to_excel('output/REM_2025_P1_SECCION_D_NODRIZAS.xlsx')
# %%
