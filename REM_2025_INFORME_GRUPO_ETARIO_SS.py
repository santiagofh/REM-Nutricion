...
def sumar_cat_por_ss(df, cat_norm, base, sufijo):
    """Suma los valores de una categoría nutricional, por SS."""
...
def sumar_total_por_ss(df, base):
    """Suma el total de prestaciones, por SS."""
...
# ---------------------------------------------------------------
with pd.ExcelWriter("output/2025_grupo_etario_por_SS.xlsx",
                    engine="xlsxwriter",
...
print("OK Archivo '2025_grupo_etario_por_SS.xlsx' creado con 1+8 hojas.")
